...
```{r,, eval = FALSE}
my_zigzag$mcmc(sample_frequency = 50, ngen = 10000, run_posterior_predictive = TRUE)
```
...
The code below plots $P(z^a_g = 1 | X)$ of all 5000 genes in relation to the empirical log-expression distributions.
